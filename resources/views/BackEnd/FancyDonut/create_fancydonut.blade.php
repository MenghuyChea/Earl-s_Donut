...
<div class="container" id="content">
    <div class="row">
        <div class="col-md-6">
            <form method="POST" action="{{url('insert_fancy_donut')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <fieldset>
                    <legend>Create Fancy Donut</legend>
                    @if(count($errors)>0)
                    ...
                    <div class="form-group">
                        ...
                        <input type="Donut" class="form-control" id="Donut" name="item_name" aria-describedby="emailHelp" placeholder="Enter Donut Name">
                    </div>
                    <div class="form-group">
