...
<div class="container" id="content">
    <div class="row">
        <div class="col-md-6">
            <form method="POST" action="{{url('insert_croissant')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <fieldset>
                    <legend>Create Croissant and Bagel</legend>
                    @if(count($errors)>0)
                    ...
                    <div class="form-group">
                        ...
                        <input type="Croissant" class="form-control" id="Croissant" name="item_name" aria-describedby="emailHelp" placeholder="Enter Croissant Name">
                    </div>
                    <div class="form-group">
